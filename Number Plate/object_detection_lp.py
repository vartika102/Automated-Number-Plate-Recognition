...
# # Model preparation 
PATH_TO_FROZEN_GRAPH = 'D:/arpan/Anaconda3/Lib/site-packages/object_detection/NUMBER_PLATE/frozen_inference_graph.pb'
# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = 'D:/arpan/Anaconda3/Lib/site-packages/object_detection/NUMBER_PLATE/labelmap.pbtxt'
NUM_CLASSES = 1
...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    #while True:
      ...
      image_np = cv2.imread('./CAR/1 (9).jpg')
      ...
      cv2.imwrite('test10.jpg', total_final[ymin:ymax,xmin:xmax])
